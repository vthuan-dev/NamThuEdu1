                ...
                {isResetting ? (
                  ...
                  <div className="px-3.5 py-3 bg-amber-50 border border-amber-200 rounded-lg flex items-start gap-2.5">
                    ...
                    <p className="text-xs text-amber-800 leading-relaxed">
                      Chưa reset mật khẩu. Nhấn nút bên dưới để đặt lại về <strong>user123</strong>.
                      <br />
                  ...
                  {confirmReset ? (
                    <div className="rounded-lg border border-rose-200 bg-rose-50 p-3">
                      <p className="text-xs font-semibold text-rose-800 mb-2">
                        Xác nhận reset mật khẩu về user123?
                      </p>
                      <p className="text-[11px] text-rose-700 mb-3 leading-relaxed">
                        Mật khẩu hiện tại của <strong>{userData.name}</strong> sẽ được đặt về{" "}
                      ...
                      <div className="flex gap-2">
                        ...
                        >
                          ...
                          {isResetting ? "Đang tạo…" : "Xác nhận → user123"}
                        </button>
                        <button
                    ...
                    >
                      ...
                      {currentPassword ? "Reset lại về user123" : "Reset mật khẩu về user123"}
                    </button>
                  )}
                </div>
              )}
