        ...
        <div className={`flex flex-1 flex-col bg-white border border-slate-200/50 shadow-inner overflow-hidden ${
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-slate-50/50">
            <div className="flex items-center gap-3">
              <div 
                className="w-10 h-10 rounded-xl flex items-center justify-center shadow-lg transition-all duration-500 ease-out border border-white/20"
                style={{ backgroundColor: themeAccent, boxShadow: `0 6px 14px ${themeAccent}20` }}
              >
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-2 py-0.5 rounded-full text-[9px] font-bold tracking-wider uppercase bg-teal-500/10 text-teal-600 border border-teal-500/20">
                    Active
                  </span>
                </div>
            ...
            <button 
              onClick={onClose} 
              className="w-9 h-9 rounded-lg text-slate-400 hover:text-slate-600 hover:bg-slate-100 flex items-center justify-center transition-all duration-300 active:scale-95"
            >
