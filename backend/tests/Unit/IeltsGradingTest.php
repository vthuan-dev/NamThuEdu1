...
class IeltsGradingTest extends TestCase
{
    use RefreshDatabase;
    ...
    /** @test */
    public function test_ielts_full_test_with_only_speaking_answered()
    {
        $teacher = $this->createTeacher();
        
        // Create IELTS Full Test exam with all 4 skills
        $exam = Exam::create([
            'eTitle' => 'IELTS Full Test',
            'eType' => 'IELTS',
    ...
    /** @test */
    public function test_ielts_full_test_with_all_skills_answered()
    {
        $teacher = $this->createTeacher();
        
        // Create IELTS Full Test exam
        $exam = Exam::create([
            'eTitle' => 'IELTS Full Test',
            'eType' => 'IELTS',
            'eSkill' => 'mixed',
    ...
    /** @test */
    public function test_ielts_reading_only_exam()
    {
        $teacher = $this->createTeacher();
        
        // Create IELTS Reading only exam
        $exam = Exam::create([
            'eTitle' => 'IELTS Academic Reading',
            'eType' => 'IELTS',
            'eSkill' => 'reading',
    ...
    /** @test */
    public function test_ielts_listening_reading_exam_with_only_listening_answered()
    {
        $teacher = $this->createTeacher();
        
        // Create IELTS exam with L+R
        $exam = Exam::create([
            'eTitle' => 'IELTS L+R',
            'eType' => 'IELTS',
            'eSkill' => 'mixed',
    ...
    /** @test */
    public function test_ielts_listening_only_exam()
    {
        $teacher = $this->createTeacher();
        
        // Create IELTS Listening only exam
        $exam = Exam::create([
        ...
        Answer::create(['question_id' => $listeningQ2->qId, 'aContent' => 'answer', 'aIs_correct' => true]);
        ...
        $answers = collect([
            ...
            new SubmissionAnswer(['question_id' => $listeningQ2->qId, 'saAnswer_text' => 'answer']), // correct
