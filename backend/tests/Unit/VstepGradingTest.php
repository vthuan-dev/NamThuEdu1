...
class VstepGradingTest extends TestCase
{
    use RefreshDatabase;
    ...
    /** @test */
    public function test_full_test_with_only_speaking_answered()
    {
        $teacher = $this->createTeacher();
        
        // Create VSTEP Full Test exam with all 4 skills
        $exam = Exam::create([
            'eTitle' => 'VSTEP Full Test',
            'eType' => 'VSTEP',
    ...
    /** @test */
    public function test_full_test_with_all_skills_answered()
    {
        $teacher = $this->createTeacher();
        
        // Create VSTEP Full Test exam
        $exam = Exam::create([
            'eTitle' => 'VSTEP Full Test',
            'eType' => 'VSTEP',
            'eSkill' => 'mixed',
    ...
    /** @test */
    public function test_reading_only_exam()
    {
        $teacher = $this->createTeacher();
        
        // Create VSTEP Reading only exam
        $exam = Exam::create([
    ...
    /** @test */
    public function test_listening_reading_exam_with_only_listening_answered()
    {
        $teacher = $this->createTeacher();
        
        // Create VSTEP exam with L+R
        $exam = Exam::create([
            'eTitle' => 'VSTEP L+R',
            'eType' => 'VSTEP',
            'eSkill' => 'mixed',
