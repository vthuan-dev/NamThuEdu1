...
Route::middleware(['auth:sanctum', 'maintenance'])->group(function () {
    ...
    Route::middleware('role:student')->prefix('student')->group(function () {
        ...
        Route::post('/tests/{submissionId}/answer', [StudentTestController::class, 'answer'])->where('submissionId', '[0-9]+')->middleware('throttle:1000,1');
        Route::post('/tests/{submissionId}/answers/bulk', [StudentTestController::class, 'bulkAnswer'])->where('submissionId', '[0-9]+')->middleware('throttle:300,1');
        Route::post('/tests/{submissionId}/submit', [StudentTestController::class, 'submit'])->where('submissionId', '[0-9]+')->middleware('throttle:300,1');
        ...
        Route::post('/tests/{submissionId}/draft',       [StudentExamSessionController::class, 'draft'])->where('submissionId', '[0-9]+')->middleware('throttle:1000,1');
        Route::post('/tests/{submissionId}/heartbeat',   [StudentExamSessionController::class, 'heartbeat'])->where('submissionId', '[0-9]+')->middleware('throttle:1000,1');
        Route::post('/tests/{submissionId}/auto-submit', [StudentExamSessionController::class, 'autoSubmit'])->where('submissionId', '[0-9]+')->middleware('throttle:300,1');
